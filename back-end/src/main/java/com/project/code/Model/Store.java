...
//    - Use @JsonManagedReference("inventory-store") to manage bidirectional relationships and avoid circular references.
    ...
    private List<Inventory> inventoryStoreList;
// 5. Add constructor:
...
//    - Add getter and setter methods for all fields (id, name, address).
    ...
    public List<Inventory> getInventoryStoreList() {
        return inventoryStoreList;
    }
    public void setInventoryStoreList(List<Inventory> inventoryStoreList) {
        this.inventoryStoreList = inventoryStoreList;
    }
}
